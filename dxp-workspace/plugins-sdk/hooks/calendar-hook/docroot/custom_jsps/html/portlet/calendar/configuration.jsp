	...
	<c:choose>
		...
		<c:when test='<%= tabs2.equals("display-settings") %>'>
			...
			<aui:fieldset label="default-tab">
				...
				<aui:input name="preferences--kolEmethCalendar--" type="checkbox" label="Kol Emeth Calendar" inlineLabel="right" value="<%= enableKolEmethCalendar %>" />
				<aui:input name="preferences--duration--" type="text"  label="Enter Duration in Month" value="<%=setDuration%>" />
