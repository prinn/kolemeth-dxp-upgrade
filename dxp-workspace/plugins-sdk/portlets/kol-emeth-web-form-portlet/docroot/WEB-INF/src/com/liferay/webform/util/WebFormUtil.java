...
public final class WebFormUtil {
	...
	public static String getEmailFromAddress(
			PortletPreferences preferences, long companyId)
	 {
		...
		try {
			 emailAddress =  PortalUtil.getEmailFromAddress(
	...
	public static String getEmailFromName(
			PortletPreferences preferences, long companyId)
		 {
		String emailFromName = StringPool.NULL;
		try {
			emailFromName = PortalUtil.getEmailFromName(
	...
	public static String getAdminEmailBody(
			PortletPreferences preferences) {
	...
	public static String getNewDatabaseTableName(String portletId)
		...
		try{
			formId = CounterLocalServiceUtil.increment(WebFormUtil.class.getName());
		 } catch (SystemException e) {
				e.getMessage();
			}
	...
	public static int getTableRowsCount(long companyId, String tableName)
		 {
			int expandoRowCount = 0;
		try {
			expandoRowCount = ExpandoRowLocalServiceUtil.getRowsCount(
				companyId, WebFormUtil.class.getName(), tableName);
		} catch (SystemException e) {
			e.getMessage();
		}
		
		return expandoRowCount;
	}
	...
	public static String[] split(String s, String delimiter) {
		...
		if (delimiter.equals("\n") || delimiter.equals("\r")) {
			...
			while (pos != -1) {
				nodeValues.add(new String(string.substring(offset, pos)));
	...
	public static boolean validate(
			...
			String validationScript) throws Exception
		 {
	...
	private static Log log = LogFactoryUtil.getLog(WebFormUtil.class);
